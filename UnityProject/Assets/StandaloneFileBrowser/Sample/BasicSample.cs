...
public class BasicSample : MonoBehaviour {
    ...
    void OnGUI() {
        ...
        if (GUILayout.Button("Open File Directory")) {
            WriteResult(StandaloneFileBrowser.OpenFilePanel("Open File", UnityEngine.Application.dataPath, "", true));
        }
        GUILayout.Space(5);
        ...
        if (GUILayout.Button("Open Folder Directory")) {
            var paths = StandaloneFileBrowser.OpenFolderPanel("Select Folder", UnityEngine.Application.dataPath, true);
            WriteResult(paths);
        }
        ...
        if (GUILayout.Button("Save File Directory")) {
            _path = StandaloneFileBrowser.SaveFilePanel("Save File", UnityEngine.Application.dataPath, "", "");
        }
        GUILayout.Space(5);
